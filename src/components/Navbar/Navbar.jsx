...
const Navbar = ({ isMenuOpen, toggleMenuState, handleModal }) => {
  return (
    <Header>
      <Container>
        <Flex width='100%' direction="row" align="center" justify='space-between'>
          ...
          <Controls>
            ...
            <Button display={'inline-block'} hiddenSm={true} size={'14px'} lheight={'18px'} onClick={handleModal}>Записатися</Button>
